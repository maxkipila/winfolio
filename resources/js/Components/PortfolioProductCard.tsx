...
function PortfolioProductCard(props: Props) {
    const { wide = false, id, img_url, name, growth, annual_growth, monthly_growth, weekly_growth, num_parts, product_num, theme_id, thumbnail, year, theme, latest_price } = props
