    ...
    return (
        <>
            ...
            <div className='border-2 border-black p-32px mt-20px mob:border-0 mob:border-t-2 mob:p-0 mob:pt-32px'>
                ...
                {
                    (product?.used_price && product?.used_range) &&
                    <>
                        ...
                        <div className='flex items-center justify-between w-full'>
                            ...
                            <div className='flex items-center gap-16px'>
                                <div className='py-6px px-8px  font-semibold font-nunito text-[#4D4D4D]'>${product?.used_price}</div>
                            </div>
                        </div>
                        <div className='flex items-center justify-between w-full pb-16px'>
                            ...
                            <div className='flex items-center gap-16px'>
                                <div className='py-6px px-8px  font-semibold font-nunito text-[#4D4D4D]'>{product?.used_range}</div>
                            </div>
                        </div>
                    </>
                }
