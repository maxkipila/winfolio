...
function Welcome(props: Props) {
    ...
    return (
        <div className='pt-[85px] font-teko'>
            <PublicHeader />
            <div className='grid'>
                <Img className='w-full col-start-1 row-start-1 object-cover' src={'/assets/img/lading-bg.png'} />
                <div className='w-full col-start-1 row-start-1 p-24px flex items-center'>
                    <div className='text-white'>
                        ...
                        <Button className='max-w-[140px]' href="">{t('Přijmout výzvu')}</Button>
                    </div>
                </div>
                <div className='w-full col-start-1 row-start-1 flex flex-col justify-end px-24px'>
                    <div className='grid grid-cols-4 gap-17px transform translate-y-[60%]'>
                        {
                            products?.map((p) =>
                                <ProductCard {...p} />
                            )
            ...
            <div className='pt-[220px] px-24px pb-48px border-b border-[#DEDFE5]'>
                ...
                <div className='mt-48px flex items-center gap-64px'>
                    ...
                    <div className='w-full'>
                        ...
                        <Button className='max-w-[140px]' href="#">{t('Vytvořit účet')}</Button>
                    </div>
                </div>
            ...
            <div className='mt-64px grid'>
                <Img className='col-start-1 row-start-1 w-full' src="/assets/img/trooper-landing.png" />
                {/* <div className='col-start-1 row-start-1 w-full px-24px flex items-center'>
                    <div className='bg-white p-24px'>
                        <div className='text-4xl font-bold'>{t('Jak to funguje?')}</div>
                        <div className='my-32px font-nunito text-lg'>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
                        <div>
                            <div className='flex mb-18px items-center gap-24px'>
                                <div className='flex items-center justify-center bg-[#F5F5F5] w-48px h-48px font-nunito text-lg'>1.</div>
                                <div className='font-nunito text-lg'>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
                            </div>
                            <div className='flex items-center gap-24px'>
                                <div className='flex items-center justify-center bg-[#F5F5F5] w-48px h-48px font-nunito text-lg'>2.</div>
                                <div className='font-nunito text-lg'>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
                            </div>
                        </div>
                    </div>
            ...
            <div className='bg-[#E9C784] pt-64px pb-[264px]'>
                <div className='font-bold text-4xl text-center'>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris</div>
                <div className='font-nunito text-center'>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
                <div className='flex items-center gap-24px justify-center mt-32px max-w-3/4 mx-auto'>
                    <div className='border-2 border-black bg-white w-full'>
                        ...
                        <div className='border-t-2 border-black p-24px'>
                            ...
                            <Button className='max-w-[160px]' href="#">{t('Začít zdarma')}</Button>
                        </div>
                    </div>
                    <div className='border-2 border-black bg-white h-full w-full'>
                        ...
                        <div className='border-t-2 border-black p-24px'>
                            ...
                            <Button className='max-w-[160px]' href="#">{t('Začít naplno')}</Button>
                        </div>
                    </div>
                </div>
            ...
            <div className='bg-white w-full h-[272px] max-h-[272px] relative'>
                <div className='transform -translate-y-1/2 px-24px'>
                    <div className='w-full bg-black grid '>
                        ...
                        <div className='bg-black px-24px h-[400px] items-center flex gap-[58px] text-white'>
                            <div className='w-full'>
                                <Img src="/assets/img/logo-white.png" />
                                <div className='font-nunito text-lg my-24px'>Lorem ipsum dolor sit amet consectetur. Eu vel vestibulum metus volutpat elit nullam ut. Urna facilisis pretium augue nunc.</div>
                                <a className='font-nunito font-bold text-lg' href="mailto:info@winfolio.cz">info@winfolio.cz</a>
                            </div>
                            <div className='w-full text-white flex flex-col gap-8px w-full'>
                                <Link className='font-nunito ' href="">{t('Jak to funguje')}</Link>
                                <Link className='font-nunito ' href="">{t('Pricing')}</Link>
                                <Link className='font-nunito font-bold' href="">{t('Sign Up / Login')}</Link>
                            </div>
                        </div>

                    </div>
                </div>
                <div className='font-nunito text-lg px-24px absolute left-0 bottom-24px'>{t('© 2025, winfolio. Všechna práva vyhrazena.')}</div>
            </div>
        </div>
    )
}
